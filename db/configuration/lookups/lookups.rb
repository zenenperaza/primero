...
Lookup.create_or_update!(
  ...
  name_en: 'Ethnicity',
  lookup_values_en: [
    { id: 'akawayo', display_text: 'Akawayo' }.with_indifferent_access,
    { id: 'amorua', display_text: 'Amorúa' }.with_indifferent_access,
    { id: 'anu', display_text: 'Añú' }.with_indifferent_access,
    { id: 'arawak', display_text: 'Arawak' }.with_indifferent_access,
    { id: 'ayaman', display_text: 'Ayamán' }.with_indifferent_access,
    { id: 'baniva', display_text: 'Baniva' }.with_indifferent_access,
    { id: 'bare', display_text: 'Baré' }.with_indifferent_access,
    { id: 'bari', display_text: 'Barí' }.with_indifferent_access,
    { id: 'kaketio', display_text: 'Kaketío' }.with_indifferent_access,
    { id: 'chaima', display_text: 'Chaima' }.with_indifferent_access,
    { id: 'enepa', display_text: 'Eñepá' }.with_indifferent_access,
    { id: 'gayon', display_text: 'Gayón' }.with_indifferent_access,
    { id: 'jivi', display_text: 'Jivi' }.with_indifferent_access,
    { id: 'wanano', display_text: 'Wanano' }.with_indifferent_access,
    { id: 'inga', display_text: 'Inga' }.with_indifferent_access,
    { id: 'japreria', display_text: 'Japreria' }.with_indifferent_access,
    { id: 'jirajara', display_text: 'Jirajara' }.with_indifferent_access,
    { id: 'jodi', display_text: 'Jodi' }.with_indifferent_access,
    { id: 'karina', display_text: 'Kariña' }.with_indifferent_access,
    { id: 'kechwa', display_text: 'Kechwa' }.with_indifferent_access,
    { id: 'kubeo', display_text: 'Kubeo' }.with_indifferent_access,
    { id: 'kuiba', display_text: 'Kuiba' }.with_indifferent_access,
    { id: 'kumanagoto', display_text: 'Kumanagoto' }.with_indifferent_access,
    { id: 'kurripako', display_text: 'Kurripako' }.with_indifferent_access,
    { id: 'mako', display_text: 'Mako' }.with_indifferent_access,
    { id: 'makushi', display_text: 'Makushi' }.with_indifferent_access,
    { id: 'mapoyo', display_text: 'Mapoyo' }.with_indifferent_access,
    { id: 'matako', display_text: 'Matako' }.with_indifferent_access,
    { id: 'pemon', display_text: 'Pemón' }.with_indifferent_access,
    { id: 'piapoko', display_text: 'Piapoko' }.with_indifferent_access,
    { id: 'piaroa', display_text: 'Piaroa' }.with_indifferent_access,
    { id: 'puinave', display_text: 'Puinave' }.with_indifferent_access,
    { id: 'pume', display_text: 'Pumé' }.with_indifferent_access,
    { id: 'saliva', display_text: 'Sáliva' }.with_indifferent_access,
    { id: 'sanema', display_text: 'Sanema' }.with_indifferent_access,
    { id: 'sape', display_text: 'Sapé' }.with_indifferent_access,
    { id: 'shiriana', display_text: 'Shiriana' }.with_indifferent_access,
    { id: 'timoto_kuika', display_text: 'Timoto-Kuika' }.with_indifferent_access,
    { id: 'tukano', display_text: 'Tukano' }.with_indifferent_access,
    { id: 'tunebo', display_text: 'Tunebo' }.with_indifferent_access,
    { id: 'uruak', display_text: 'Uruak' }.with_indifferent_access,
    { id: 'waikeri', display_text: 'Waikerí' }.with_indifferent_access,
    { id: 'wapishana', display_text: 'Wapishana' }.with_indifferent_access,
    { id: 'warao', display_text: 'Warao' }.with_indifferent_access,
    { id: 'warekena', display_text: 'Warekena' }.with_indifferent_access,
    { id: 'wayuu', display_text: 'Wayuu' }.with_indifferent_access,
    { id: 'yanomami', display_text: 'Yanomami' }.with_indifferent_access,
    { id: 'yabarana', display_text: 'Yabarana' }.with_indifferent_access,
    { id: 'yekuana', display_text: 'Yekuana' }.with_indifferent_access,
    { id: 'yeral', display_text: 'Yeral' }.with_indifferent_access,
    { id: 'yukpa', display_text: 'Yukpa' }.with_indifferent_access,
    { id: 'otro', display_text: 'Otro' }.with_indifferent_access,
    { id: 'no_declarado', display_text: 'No declarado' }.with_indifferent_access
  ]
)
...
Lookup.create_or_update!(
  ...
  name_en: 'Religion',
  lookup_values_en: [
    { id: 'catolico', display_text: 'Católico' }.with_indifferent_access,
    { id: 'evangelico', display_text: 'Evangélico' }.with_indifferent_access,
    { id: 'irreligion', display_text: 'Irreligión' }.with_indifferent_access,
    { id: 'ateo', display_text: 'Ateo' }.with_indifferent_access,
    { id: 'adventista', display_text: 'Adventista' }.with_indifferent_access,
    { id: 'testigo_de_jehova', display_text: 'Testigo de Jehová' }.with_indifferent_access,
    { id: 'mormon', display_text: 'Mormón' }.with_indifferent_access,
    { id: 'otro', display_text: 'Otro' }.with_indifferent_access,
    { id: 'no_sabe', display_text: 'No sabe' }.with_indifferent_access,
    { id: 'no_responde', display_text: 'No responde' }.with_indifferent_access
  ]
)
...
Lookup.create_or_update!(
  ...
  lookup_values_en: [
    ...
    { id: 'denial_of_resources_opportunities_or_services',
      display_text: 'Denial of Resources, Opportunities or Services' }.with_indifferent_access,
...
Lookup.create_or_update!(
  ...
  lookup_values_en: [
    ...
    { id: 'family_abuse_violence_exploitation',
      display_text: 'Family abuse/violence/exploitation' }.with_indifferent_access,
    { id: 'lack_of_access_to_services_support',
      display_text: 'Lack of access to services/support' }.with_indifferent_access,
    ...
    { id: 'entrusted_into_the_care_of_an_individual',
      display_text: 'Entrusted into the care of an individual' }.with_indifferent_access,
...
Lookup.create_or_update!(
  ...
  lookup_values_en: [
    ...
    { id: 'service_provided_by_your_agency',
      display_text: 'Service provided by your agency' }.with_indifferent_access,
    { id: 'services_already_received_from_another_agency',
      display_text: 'Services already received from another agency' }.with_indifferent_access,
